"""Serving-owned Tool Call batch policy and atomic publication state."""
...
class ToolCallBatchGate:
    """Own Tool Call stream validation, bounded atomic buffering, and one-shot commit/abort."""
    ...
    def on_completed(self, event: ToolCallCompleted) -> BatchDecision:
        ...
        if not validation.is_valid:
            ...
            return BatchDecision(failure=BatchFailure(code, message))
