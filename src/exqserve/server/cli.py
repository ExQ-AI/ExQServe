...
def _build_parser(
    *,
    ...
    parser.add_argument(
        ...
        choices=("claude-code", "claude-code-2.1.251"),
        help="Enable best-effort Claude Code compatibility; claude-code-2.1.251 is a legacy alias.",
    )
    parser.add_argument(
        "--renderer-workers",
        type=int,
...
def parse_config(argv: Sequence[str] | None = None) -> ServerConfig:
    ...
    return ServerConfig(
        ...
        cache_value_bits=value_bits,
        max_batch_size=args.max_batch_size,
        max_chunk_size=args.max_chunk_size,
        reserve_per_device_gb=reserve,
        max_in_flight=args.max_in_flight,
        max_prompt_tokens=args.max_prompt_tokens,
        max_output_tokens=args.max_output_tokens,
        max_total_tokens=args.max_total_tokens,
        timeout_seconds=args.timeout_seconds,
        default_api_output_tokens=args.default_output_tokens,
        response_store_max_records=args.response_store_max_records,
        ...
        qc_staging=args.qc_staging,
        max_requeue_tokens=args.max_requeue_tokens,
        vision_enabled=args.vision,
        vision_offload=args.vision_offload,
        allow_remote_images=args.allow_remote_images,
        max_image_bytes=args.max_image_bytes,
        api_keys=_configured_api_keys(args),
        protect_metrics=not args.public_metrics,
        max_request_body_bytes=args.max_request_body_bytes,
        response_store_ttl_seconds=args.response_store_ttl_seconds,
        response_store_max_bytes=args.response_store_max_bytes,
        model_root=args.model_root,
        draft_model=args.draft_model,
        draft_tokens=args.draft_tokens,
        draft_cache_bits=draft_bits,
        loras=() if args.lora is None else tuple(args.lora),
        lora_scalings=() if args.lora_scaling is None else tuple(args.lora_scaling),
        sampling_overrides=sampling_overrides,
        tensor_parallel=args.tensor_parallel,
        tp_backend=args.tp_backend,
        tp_output_device=args.tp_output_device,
        device_ids=device_ids,
        dynamic_draft_tokens=args.dynamic_draft_tokens,
        draft_confidence=args.draft_confidence,
        chat_template=args.chat_template,
        max_injection_body_bytes=args.max_injection_body_bytes,
        vision_cache_mb=args.vision_cache_mb,
        model_dialect=args.model_dialect,
        tool_constraint_mode=ToolConstraintMode(args.tool_constraint_mode),
        sysmem_kv_cache_mb=args.sysmem_kv_cache_mb,
        sysmem_recurrent_cache_mb=args.sysmem_recurrent_cache_mb,
        ngram_match_min=args.ngram_match_min,
        ngram_draft_size=args.ngram_draft_size,
        ...
        anthropic_compatibility_profile=args.anthropic_compatibility_profile,
